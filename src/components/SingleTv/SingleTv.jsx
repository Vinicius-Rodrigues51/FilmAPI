...
import PlayIcon from "../../Assets/play_logo.svg";
import {
  Wraper,
  Backdoor,
  Content,
...
const SingleTv = () => {
  ...
  if (data === null) {
    ...
    return (
      <Fragment>
        {modal && (
          <Modal modal={modal} setModal={setModal} id={id} type={type} />
        )}
    ...
    return (
      <Fragment>
        ...
        <Wraper
          style={{
            backgroundImage: `url(https://image.tmdb.org/t/p/w1000_and_h450_multi_faces${data.backdrop_path})`,
          }}
        >
          <Backdoor>
            <MobileContent>
        ...
        <MobileDetails>
          <div className="titleBox">
            <h1 className="title">
              {data.name} <span>({data.first_air_date.substr(0, 4)})</span>
            </h1>
          </div>

          <div className="vote_trailer">
            <div className="vote">
              <ProgressBar data={data.vote_average.toFixed(1)} />
              <h2>
